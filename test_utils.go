...
// RandomBigInt generates random big integer
...
// CreateMockPools creates mock pool data for testing
func CreateMockPools() []*types.Pool {
	...
	// Use big.Int to handle large numbers
